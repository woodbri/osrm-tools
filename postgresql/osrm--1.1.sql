...
CREATE OR REPLACE FUNCTION osrm_locate(
    ...
    AS 'MODULE_PATHNAME', 'osrm_locate'
...
CREATE OR REPLACE FUNCTION osrm_nearest(
    ...
    AS 'MODULE_PATHNAME', 'osrm_nearest'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_viaroute(
    ...
    AS 'MODULE_PATHNAME', 'osrm_viaroute'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_dmatrixGetJson(
    ...
    AS 'MODULE_PATHNAME', 'osrm_dmatrix_get_json'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_dmatrix(
    ...
    AS 'MODULE_PATHNAME', 'osrm_dmatrix'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_dmatrix(
    ...
    AS 'MODULE_PATHNAME', 'osrm_dmatrix_row'
    LANGUAGE c IMMUTABLE STRICT;
*/
...
CREATE OR REPLACE FUNCTION osrm_jgetVersion(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_version'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_jgetStatus(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_status'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_jgetRoute(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_route'
    LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION osrm_jgetRouteText(
        IN json text,
        IN alt boolean default false,
        OUT seq integer,
        OUT rtext text
    ) RETURNS SETOF RECORD
    AS 'MODULE_PATHNAME', 'osrm_jget_route_text'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_jgetSummary(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_summary'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_jgetViaPoints(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_viapoints'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_jgetRouteNames(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_route_names'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION osrm_jgetHints(
    ...
    AS 'MODULE_PATHNAME', 'osrm_jget_hints'
    LANGUAGE c IMMUTABLE STRICT;
